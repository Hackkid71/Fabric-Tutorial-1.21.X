package net.will.tutorialmod.block;
...
import net.will.tutorialmod.TutorialMod;
import net.will.tutorialmod.block.custom.MagicBlock;
import net.will.tutorialmod.block.custom.PinkGarnetLampBlock;
